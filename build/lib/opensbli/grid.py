...
class Grid(object):
    ...
    def __init__(self, ndim, grid_data=None):
        ...
        if grid_data:
            ...
            self.grid_data_dictionary = dict(list(zip(variables, values)))
        ...
        self.mapped_indices = dict(list(zip(tuple(self.coordinates)+self.indices, self.indices+self.indices)))
